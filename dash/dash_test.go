...
// Larger test across all 3 letter words, from the aah to zzz
func BenchmarkDashFullAlphabet(b *testing.B) {
	dictionary := []string{
		"aah",
		"aal",
		"aas",
	...
	for i := 0; i < b.N; i++ {
		dd := NewDictionaryDash(dictionary)
		dd.Dash("zzz", "aah")
	}
}

func BenchmarkDashAllToAwe(b *testing.B) {
	dictionary := []string{
		"abs",
		"aby",
		"ace",
